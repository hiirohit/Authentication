...
function ResetPassword() {
  ...
  const handleChange = (e, index) => {
    ...
    const onSubmitEmail = async (e) => {
      ...
      setLoading(true);
      try{
        const resopnse = await axios.post(backend_url+"/send-reset-otp?email="+email);
    ...
    <div className='email-verify-container d-flex align-items-center justify-content-center vh-100 position-relative'
        ...
        {!isOtpSubmitted && isEmailSent && (
          <div className="p-5 rounded-4 shadow bg-white" style={{width:"400px"}}>
                     ...
                     <div className="d-flex justify-content-between gap-2 text-center text-white-50 mb-2">
                        {[...Array(6)].map(( _,i) => (
                     ...
                     <button className="btn btn-primary w-100 fs-semibold" disabled={loading} onClick={handleVerify}>
                          ...
                          <div className='rounded-4 p-4 text-center bg-white' style={{width:"100%", maxWidth:"400px"}}>
                               ...
                               <form onSubmit={onSubmitNewPassword}>
                                    <div className='input-group mb-4 bg-secondary bg-opacity-10 rounded-pill'>
                                      ...
                                      <input type="password" 
                                             className='form-control bg-transparent border-0 ps-1 rounded-end'
                                             placeholder='********'
                                             style={{height:"50px"}}
